...
def color_threshold(img, s_thresh=(0, 255), v_thresh=(0, 255),
                    sensitivity_1=68, sensitivity_2=60):
    ...
    white_2 = cv2.inRange(hls, (0, 255-sensitivity_2, 0),
                          (255, 255, sensitivity_2))
    ...
    binary_output = np.zeros_like(white)
    binary_output[(yellow == 255) | (white == 255) | (white_2 == 255) |
                  (white_3 == 255) | ((s_binary == 1) & (v_binary == 1))] = 1
